...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Read row for selected client from db table
    $sql = "SELECT * FROM shopclients WHERE id=$id"; // Missing semicolon added
    ...
    do {
        ...
        $sql = "UPDATE shopclients SET name = ?, email = ?, phone = ?, address = ? WHERE id = ?";
